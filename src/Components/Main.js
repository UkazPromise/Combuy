...
const Main = () => {
  return (
    <>
      <div className="flex space-x-4 rounded h-96 w-full mt-4">
        <div className="rounded border-2 border-black-600 h-48 w-1/3 space-y-3 bg-slate-100 divide-y-2">
            ...
            <ul className=" marker:text-sky-400 list-disc pl-5">
              ...
              <li className='mt-2 hover:text-red-600 font-semibold transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'><a href="#">Acessories</a></li>
            </ul>
        </div>
